          ...
          {isOpen && (
            ...
            >
              <div className="p-2">
                <Link
                  href="#"
                  className="flex items-center px-4 py-1 text-base text-gray-700 hover:bg-gray-100 rounded-lg"
                >
                ...
                <Link
                  href="#"
                  className="flex items-center px-4 py-1 text-base text-rose-600 hover:bg-gray-100 rounded-lg"
                >
